...
-- load a file using real path
function OpenMpt:loadFullPath(filename)
...
-- load a file using sandboxed path
function OpenMpt:load(filename)
  self.filename = filename
  local contents, size = love.filesystem.read(filename)
  self.module = openmpt.openmpt_module_create_from_memory2(contents, size, nil, nil, nil, nil, nil, nil, nil)
end
